...
export default function Panel({
   history,
    ...
    return (
        <div className={"absolute h-full right-0 top-0 bg-green text-emerald " + (isExpanded ? 'w-3/4' : 'w-[20px]') + " max-w-lg transition-all duration-300 ease-in-out transform h-fill"}>
            <aside>
                {isExpanded && (
