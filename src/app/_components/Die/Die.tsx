...
export default function Die({
    ...
    const renderDieSelection = () => {
        switch (dieNumber) {
            case 2:
            case 100:
                return <svg width="32" height="32" onClick={() => removeDie && removeDie(id)}>
            ...
            case 20:
                return <svg width="36px" height="36px" viewBox="0 0 36 36" onClick={() => removeDie && removeDie(id)}>
            ...
            case 6:
                return <svg width="28" height="28" onClick={() => removeDie && removeDie(id)}>
